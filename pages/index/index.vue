	...
	<view class="container">
		<view class="banner">
			...
			<view class="intro">
				...
				<view class="note">欢迎光临奶茶雪糕店</view>
			</view>
		</view>
		<view class="content">
			<view class="entrance">
				...
				<view class="left">
					<view class="grid flex-column just-content-center">
						<view class="d-flex align-items-center">
							<view class="font-size-sm">网红雪糕</view>
						</view>
						<view style="margin-left: 40rpx; font-size: 20rpx;">回忆80、90年代</view>
					</view>
				...
				<view class="right">
					<view class="tea-activity" @tap="invite">
						...
						<view class="right-img">
							<image src="/static/images/index/mcsb.png" mode="widthFix"></image>
						</view>
					</view>
			...
			<view class="member-news">
				...
				<view class="list">
					<view class="item">
						<image src="/static/images/index/shop.png"></image>
					</view>
				</view>
			</view>
		</view>
